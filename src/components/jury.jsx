...
//    ];
    ...
    var educational = [
        ...
        {"avatar": DefaultAvatar, "name": "Matei Adriel Rafael", "occupation": "student @ University of Groningen"},
    ...
    var web = [
        ...
        {"avatar": DefaultAvatar, "name": "Dan Andrei Novac", "occupation": "inginer @ SC eMag IT Research SRL Iași"},
